...
class TechnicalTest {
  ...
  List list = [
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      var output = DateTime(2000, 12, 31);
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      var output = DateTime(1995, 09, 15);
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      var output = DateTime(2023, 05, 10);
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      var output = DateTime(2010, 11, 24);
    ...
    () {
      ...
      List<Map<String, dynamic>> output = [
        ...
        {
          "name": "David",
          "courses": ["Computer Science", "Programing"]
        },
        {
          "name": "Eve",
    ...
    () {
      ...
      output =
          "${input.year}-${input.month < 10 ? '0' + input.month.toString() : input.month}-${input.day < 10 ? '0' + input.day.toString() : input.day}";

      print(output); // Output: 2023-08-09
      // --- End of Answer ---
    ...
    () {
      ...
      List<Map<String, dynamic>>? output =
          List<Map<String, dynamic>>.from(input);
    ...
    () {
      ...
      List<int>? output = input.split(",").map(int.parse).toList();
    ...
    () {
      ...
      List<double>? output = input.split(",").map(double.parse).toList();
    ...
    () {
      ...
      output = {for (var i in input) "number": i};
      // --- End of Answer ---
    ...
    () {
      ...
      output = {for (var item in input) item: item};
      // --- End of Answer ---
    ...
    () {
      ...
      List<Map<String, int>> input = [{"apple": 3}, {"banana": 2}];
      Map<String, int>? output;
      output = input.firstWhere((map) => map.containsKey("apple"));
      // --- End of Answer ---
    ...
    () {
      ...
      String input = "apple,banana,cherry";
      Map<String, int>? output;
      output = {for (var fruit in input.split(',')) fruit: 1};
      // --- End of Answer ---
    ...
    () {
      ...
      output = {for (var value in input.split(',')) int.parse(value): "value"};
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      List<Map<String, int>> input = [{"apple": 3}, {"banana": 2}, {"cherry": 1}];
      List<int>? output;
      output = input.map((map) => map.values.first).toList();
      // --- End of Answer ---
    ...
    () {
      ...
      output = input.map((fruit) => {"length": fruit.length}).toList();
      // --- End of Answer ---
  ...
  List<int>? output;
  output = input.map((map) => map["value"] as int).toList();
      // --- End of Answer ---
...
() {
  ...
  // Extracting the text between the quotes:
...
// Exercise 229
() {
  List<int> numbers = [70, 23, 44, 33, 100, 23, 109];
  double total = 0;
...
() {
  ...
  // Subtracting input1 from input2:
...
() {
  ...
  // Calculating the remainder of input2 divided by input1:
  output = input2 % input1;
...
() {
  ...
  // Checking if input is an even number:
  output = input % 2 == 0;
...
() {
  ...
  // Checking if input is an odd number:
  output = input % 2 != 0;
...
() {
  ...
  // Checking if input has more than 3 characters:
...
() {
  ...
  // Checking if input has exactly 3 characters:
  output = input.length == 3;
...
() {
  ...
  // Checking if the first character is 'D':
...
() {
  ...
  // Checking if the last character is 't':
...
() {
  ...
  // Checking if input has 5 digits:
...
() {
  ...
  // Checking if input has 4 digits:
...
() {
  ...
  // Checking if input has 2 digits after the decimal point:
  output = input.toString().split(".")[1].length == 2;
...
() {
  ...
  // Checking if input has 3 digits after the decimal point:
  output = input.toString().split(".")[1].length == 3;
...
() {
  ...
  return output == false;
    ...
    () {
      ...
      bool output = int.tryParse(input) != null;
    ...
    () {
      ...
      int output = numbers.fold(10, (previous, current) => previous + current);
      return output == 25;
    },
